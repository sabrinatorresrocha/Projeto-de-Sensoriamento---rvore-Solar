...
const GraficoLinha = ({ dados }: { dados: DadosHistoricos[] }) => {
    ...
    const TENSE_COLOR = "#3b82f6"; // Azul (Tensão)
    const CURRENT_COLOR = "#10b981"; // Verde (Corrente)
    const POWER_COLOR = "#f59e0b"; // Amarelo/Laranja (Potência)

    const handleButtonClick = (dataKey: keyof typeof activeLines) => { 
        setActiveLines(prev => ({
            ...prev,
            [dataKey]: !prev[dataKey] // Alterna o estado da linha clicada
        }));
    };
                    ...
                    {arquivos.length > 0 && (
                        <div className="mb-6 flex justify-center">
                            <button
                                ...
                                className="px-6 py-3 bg-red-500 text-white font-bold rounded-xl shadow-lg hover:bg-red-800 transition-colors text-lg w-full md:w-auto"
                            >
                                ...
                                >
                                    ...
                                    <div className="flex gap-3">
                                        <a 
                                            ...
                                            download={arquivo} 
                                            className="flex items-center px-3 py-2 bg-red-500 text-white font-semibold rounded-md hover:bg-red-500 transition-colors text-sm"
                                        >
